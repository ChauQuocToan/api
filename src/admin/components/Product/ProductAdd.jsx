...
export default function ProductAdd() {
  ...
  return (
    <div className="container">
      <form id="createProduct" action="" className="m-auto" style={{ minWidth: 600 }} onSubmit={handleSubmit}>
        ...
        <div className="form-group mb-3 row">
          ...
          <div className="col-md-7">
            <input type="text" className="form-control" id="slug" name="slug" onChange={handleChange} />
          </div>
        </div>
        <div className="form-group mb-3 row">
          ...
          <div className="col-md-7">
            <SelectCategory defaultValue="-1" handleFunction={handleChange}></SelectCategory>
          </div>
        </div>
        <div className="form-group mb-3 row">
          ...
          <div className="col-md-7">
            <SelectBrand defaultValue="-1" handleFunction={handleChange}></SelectBrand>
          </div>
        </div>
        <div className="form-group mb-3 row">
          ...
          <div className="col-md-7">
            <input type="text" className="form-control" id="img1" name="image" onChange={handleChange} />
          </div>
        </div>
        <div className="form-group mb-3 row">
        ...
        <div className="form-group mb-3 row">
          ...
          <div className="col-md-7">
            <input type="text" className="form-control" id="price8" name="price" onChange={handleChange} />
          </div>
        </div>
        <div className="form-group mb-3 row">
        ...
        <div className="form-group mb-3 row">
          ...
          <div className="col-md-7">
            <input type="text" className="form-control" id="type10" name="type" onChange={handleChange} />
          </div>
        </div>
        <div className="form-group mb-3 row">
